...
def write_question(export_row):
    write_csv(QUESTION_FILE_PATH, QUESTION_HEADER, export_row)
...
def write_answer(export_row):
    write_csv(ANSWER_FILE_PATH, ANSWER_HEADER, export_row)
